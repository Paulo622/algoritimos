    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int mes = 1; mes <= 12; mes++)
            {
                ...
                int[,] calendario;
                gerarCalendário(ano, mes, out primeiroDiaMes, out calendario);
                ImprimirCalendario(ano, mes, primeiroDiaMes, calendario);
        ...
        private static void ImprimirCalendario(int ano, int mes, DateTime primeiroDiaMes, int[,] calendario)
        {
            Console.WriteLine($"\nCalendário de " +
        ...
        private static void gerarCalendário(int ano, int mes, out DateTime primeiroDiaMes, out int[,] calendario)
        {
